...
const LoginPage = () => {
    ...
    const loginUser = () => {
        ...
        // save email address as it is cleared when fetch call is made
        ...
        .then (
            (json) => {
                ...
                // If web token exists in the backend (meaning login successful)
                if(jsonwebtoken) {
                    ...
                    <div className="row">
                        ...
                        style={{maxWidth: '400px', margin: '0 auto'}}>
                            <div>
                                ...
                                <p><br/>If you are not a registered user, click  <Link to="/register">here</Link> to create an account</p>
